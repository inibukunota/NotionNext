...
module.exports = {
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || '6UYRmTg6v5tHtoELNDO7r7OzqVp0_LOIMvwoZoNW5mE', // Remove the value or replace it with your own google site verification code
