...
module.exports = {
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-P6GE9535PM', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'google-site-verification=6UYRmTg6v5tHtoELNDO7r7OzqVp0_LOIMvwoZoNW5mE', // Remove the value or replace it with your own google site verification code
